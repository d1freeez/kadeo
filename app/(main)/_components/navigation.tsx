...
export const Navigation = () => {
  ...
  const handleCreate = () => {
    ...
    toast.promise(promise, {
      loading: "Jana kade jasau...",
      success: "Kade jasaldy!",
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <Item onClick={handleCreate} label="Jana Kade" icon={PlusCircle} />
        </div>
        <div className="mt-4">
          <DocumentList />
          <Item onClick={handleCreate} icon={Plus} label="Jana Bet" />
          <Popover>
